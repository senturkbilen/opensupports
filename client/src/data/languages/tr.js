export default {
    ...
    'TICKET_LIST': 'Talep Listesi',
    'SUPPORT_CENTER': 'Destek Merkezi',
    'DEPARTMENT': 'Bölüm',
    'AUTHOR': 'Yazar',
    'DATE': 'Tarih',
    'RESPOND': 'Yanıtla',
    'RESPOND_TICKET': 'Talebe git',
    ...
    'NEW_TICKETS': 'Yeni Talepler',
    'ALL_TICKETS': 'Bütün Talepler',
    ...
    'VIEW_TICKET_DESCRIPTION': 'Talep numaranızı ve e-postanızı kullanarak talebinizin durumunu kontrol edin.',
    ...
    'ASSIGNED': 'Atanmış',
    'ASSIGNED_TICKETS': '{tickets} talep atandı',
    'CLOSED_TICKETS': '{tickets} kapalı talepler',
    'LAST_LOGIN': 'Son giriş',
    'ADD_NEW_STAFF': 'Yeni personel ekle',
    'ADD_STAFF': 'Personel ekleme',
    'LEVEL': 'Seviye',
    'LEVEL_1': 'Seviye 1 (Talepler)',
    'LEVEL_2': '2. Seviye (Talepler + Makaleler)',
    'LEVEL_3': 'Seviye 3 (Talepler + Makaleler + Personel)',
    'LEVEL_1_DESCRIPTION': 'Yalnızca talepleri cevaplayabilir ve kullanıcıları yönetebilir.',
    ...
    'TRANSFER_TICKETS_TO': 'Talebi transfer için',
    'COMMENTS': 'Yorumlar',
    ...
    'SUPPORTED_LANGUAGES_INFO': 'Desteklenen diller talepleri yazabileceğiniz dillerdir.',
    ...
    'CHECK_TICKET': 'Talebini kontrol et',
    'ACTIVITY': 'Aktivite',
    'HOME': 'Ev',
    'TICKET_NUMBER': 'Talep numarası',
    'NEXT': 'Sonraki',
    'SUBJECT': 'konu',
    'SEND_EMAIL_ON_NEW_TICKET': 'Yeni taleple e-posta gönder',
    ...
    'SHOW_CLOSED_TICKETS': 'Kapalı Talepleri Göster',
    ...
    'CHART_CREATE_TICKET': 'Talepler oluşturuldu',
    'CHART_CLOSE': 'Talepler kapandı',
    'CHART_SIGNUP': 'Kayıtlar',
    'CHART_COMMENT': 'Cevaplar',
    'CHART_ASSIGN': 'Atanmış',

    //ACTIVITIES
    'ACTIVITY_COMMENT': 'Yorumlanan talep',
    'ACTIVITY_ASSIGN': 'Tahsis edilen talep',
    'ACTIVITY_UN_ASSIGN': 'Atanmamış talep',
    'ACTIVITY_CLOSE': 'Kapalı talep',
    'ACTIVITY_CREATE_TICKET': 'Talep yarattı',
    'ACTIVITY_RE_OPEN': 'Yeniden açılan talep',
    'ACTIVITY_DEPARTMENT_CHANGED': 'Talebin departmanı değişti',
    'ACTIVITY_PRIORITY_CHANGED': 'Talebin önceliği değiştirildi',
    'ACTIVITY_EDIT_COMMENT': 'Talep düzenleme yorumu',

    'ACTIVITY_EDIT_SETTINGS': 'Düzenlenmiş ayarlar',
    'ACTIVITY_SIGNUP': 'Kaydoldu',
    'ACTIVITY_EDIT_TITLE': 'Talep düzenlenmiş başlık',
    ...
    //VIEW DESCRIPTIONS
    'CREATE_TICKET_DESCRIPTION': 'Bu, bir talep oluşturmak için kullanılan bir form. Formu doldurun ve bize sorunlarınızı / şüphelerinizi / önerileri gönderin. Destek sistemimiz mümkün olan en kısa zamanda cevaplayacaktır.',
    'TICKET_LIST_DESCRIPTION': 'Burada, destek ekibinize gönderdiğiniz tüm taleplerin bir listesini bulabilirsiniz.',
    'TICKETS_DESCRIPTION': 'Destek merkezimizden talep gönderin ve şüphe, öneri ve sorunlarınızdan yanıt alın.',
    'ARTICLES_DESCRIPTION': 'Sık karşılaşılan sorunlar, kılavuzlar ve belgelerle ilgili makalelerimize bir göz atın.',
    'ACCOUNT_DESCRIPTION': 'Tüm talepler hesabınızın profilinde saklanır. Personel ekibinize gönderdiğiniz tüm taleplerinizi takip edin.',
    'SUPPORT_CENTER_DESCRIPTION': 'Destek merkezimize hoş geldiniz. Bir talep sistemi aracılığıyla bizimle iletişime geçebilirsiniz. Talepleriniz personelimiz tarafından cevaplandırılacaktır.',
    'CUSTOM_RESPONSES_DESCRIPTION': 'Özel yanıtlar, ortak sorunlar için otomatik yanıtlardır',
    'CUSTOM_TAGS_DESCRIPTION': 'Burada, daha iyi tanımlamak için taleplerin özel etiketlerini yönetmeyi görebilirsiniz.',
    'MY_TICKETS_DESCRIPTION': 'Buradan sorumlu olduğunuz talepleri görüntüleyebilirsiniz.',
    'NEW_TICKETS_DESCRIPTION': 'Burada herkes tarafından atanmamış tüm yeni talepleri görüntüleyebilirsiniz.',
    'ALL_TICKETS_DESCRIPTION': 'Burada, atanan bölümlerin taleplerini görebilirsiniz.',
    'TICKET_VIEW_DESCRIPTION': 'Bu talep bir müşteri tarafından gönderilmiştir. Buraya cevap verebilir veya talep atayabilirsin',
    ...
    'USER_VIEW_DESCRIPTION': 'Burada bir kullanıcı hakkında tüm bilgileri ve kullanıcı tarafından gönderilen tüm talepleri bulabilirsiniz. Ayrıca silebilir veya yasaklayabilirsiniz.',
    'DELETE_USER_DESCRIPTION': 'Kullanıcı yaşlanmaya giriş yapamaz ve tüm talepleri silinir. Ayrıca, e-posta artık kullanılamaz.',
    'DELETE_TOPIC_DESCRIPTION': 'Konuyu silerek, üzerindeki tüm makaleler silinecek.',
    'SEARCH_TICKETS_DESCRIPTION': 'Burada belirli filtreler tarafından talep arama yapabilirsiniz',
    ...
    'DEPARTMENTS_DESCRIPTION': 'Bir bölüm, talepleri gidebilecek bir gruptur. Talepleri kategorize etmek için kullanılırlar. Onları diğer çalışanlara atayabilirsiniz.',
    ...
    'STATISTICS_DESCRIPTION': 'Burada, talepler ve kayıtlar ile ilgili istatistikleri görebilirsiniz.',
    ...
    'SIGN_UP_VIEW_DESCRIPTION': 'Burada, destek merkezimiz için bir hesap oluşturabilirsiniz. Talep göndermek ve belgeleri görmek için gereklidir.',
    'EDIT_PROFILE_VIEW_DESCRIPTION': 'Burada e-postanızı veya şifrenizi değiştirerek kullanıcıyı düzenleyebilirsiniz.',
    'ENABLE_USER_SYSTEM_DESCRIPTION': 'Bir kullanıcı sisteminin kullanımını etkinleştirir / devre dışı bırakır. Devre dışı bırakırsanız, tüm kullanıcılar silinir ancak talepler muhafaza edilir. Etkinleştirirseniz, mevcut talepler kullanıcıları oluşturulur.',
    ...
    'IMAP_SERVER_DESCRIPTION': 'IMAP sunucusunun yapılandırması, uygulamanın bir posta kutusuna gönderilen e-postalardan talep oluşturmasına izin verir.',
    'ENABLE_USER_DESCRIPTION': 'Bu eylem, kullanıcının giriş yapmasına ve talep oluşturmasına izin verir.',
    'DISABLE_USER_DESCRIPTION': 'Kullanıcı devre dışı bırakılacak ve oturum açıp talep oluşturamayacak.',
    ...
    'TICKET_SENT_ERROR': 'Talep oluşturulmaya çalışılırken bir hata oluştu.',
    ...
    'ERROR_RETRIEVING_TICKETS': 'Talepler almaya çalışılırken bir hata oluştu.',
    ...
    'INVALID_EMAIL_OR_TICKET_NUMBER': 'Geçersiz e-posta veya talep numarası',
    ...
    'DEPARTMENT_PRIVATE_TICKETS': 'Bu departman, personel olmayanlar tarafından oluşturulan taleplere sahiptir ve özel olamaz',
    ...
    'TICKET_SENT': 'Talep başarıyla oluşturuldu.',
    ...
    'WILL_DELETE_DEPARTMENT': 'Bölüm silinecek. Tüm talepler, seçilen bölüme transfer olacak.',
    'NO_STAFF_ASSIGNED': 'Bu bölüme hiçbir personel atanmamaktadır.',
    'NO_DEPARTMENT_ASSIGNED': 'Hiçbir talep departmanı size atanmadı.',
    ...
    'WILL_DELETE_STAFF': 'Bu eleman silinecek ve tüm talepleri görevsiz bırakılacaktır.',
    ...
    'TEST': 'Ölçek',
    'ACTIVITY_COMMENT_THIS': 'bu talepi yorumladı',
    'ACTIVITY_ASSIGN_THIS': 'bu talepi atadı',
    'ACTIVITY_UN_ASSIGN_THIS': 'bu talebin atanmamış',
    'ACTIVITY_CLOSE_THIS': 'bu talep kapatıldı',
    'ACTIVITY_CREATE_TICKET_THIS': 'bu talep oluşturuldu',
    'ACTIVITY_RE_OPEN_THIS': 'bu talep yeniden açıldı',
    'ACTIVITY_DEPARTMENT_CHANGED_THIS': 'bu talebin bölümünü değiştir',
    'ACTIVITY_PRIORITY_CHANGED_THIS': 'bu talebin önceliğini değiştirildi',
